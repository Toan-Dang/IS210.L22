--question1
CREATE TABLE SKILL (SkillNo INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY , SkillName NVARCHAR2(255) NOT NULL, Note nvarchar2(255));
CREATE TABLE DEPARTMENT (DeptNo INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY , DeptName NVARCHAR2(255) NOT NULL, Note nvarchar2(255));
...
CREATE TABLE EMP_SKILL(
	 ...
	 EDescription nvarchar2(255) NOT NULL ,
...
ALTER TABLE EMP_SKILL DROP COLUMN EDescription;
--QUESTION 4
--INSERT SKILL
...
8	,	  -- EmpNo - int
1	,	  -- SkillLevel - int
(SELECT SYSDATE FROM DUAL)-- RegDate - datetime
	);
